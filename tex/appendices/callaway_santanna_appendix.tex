...
Figure \ref{fig:cs_event_studies} presents event study plots for key outcomes using the CS dynamic aggregation. These plots show treatment effects by decades relative to public housing project opening, providing insight into both pre-treatment trends and post-treatment dynamics.
...
\end{figure}
\footnotesize
\textit{Notes:} Event study plots from Callaway-Sant'Anna staggered DiD estimator showing treatment effects by decades relative to public housing opening. Simultaneous 95\% confidence intervals shown. The estimator uses not-yet-treated controls and includes 1940 baseline characteristics as controls.
