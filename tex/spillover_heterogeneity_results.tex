...
While our main spillover analysis reveals modest average effects on neighboring areas, these aggregate estimates may mask important heterogeneity. To explore this possibility, we examine how spillover effects vary along three key dimensions: public housing project size, baseline neighborhood racial composition, and baseline neighborhood income. We implement this analysis using our inherited spillover approach, where inner rings of treated tracts are compared to inner rings of matched control tracts, with heterogeneity measured using baseline ($t = -10$) characteristics of the treated tracts.
