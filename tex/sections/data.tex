...
Figure \ref{fig:chicago_spillover} illustrates this spillover definition using Chicago as an example, showing public housing projects (treated tracts) and the adjacent spillover areas.
  ...
  \note{This map shows census tracts in Chicago containing public housing projects built between 1941-1973 (red) and
   adjacent spillover areas (blue) defined using the contiguity-and-distance criteria described in the text. Other
  areas (gray) represent tracts used as controls in the spatial difference-in-differences analysis.}
  \end{figure}
...
First, I drop tracts for which I cannot calculate population by race, median income, median rent, labor force participation rates, and unemployment rates for all years.  

I make several further sample restrictions. I exclude tracts with public housing built before my analysis period (pre-1941).
I also drop outlier population tracts that are above the 98th percentile ($14,651$) or below the 2nd percentile ($98.2$) of population in any year.
I exclude metropolitan areas that either have few total tracts ($< 50$ total tracts), or have a very high share of treated tracts ($> 30\%$ of tracts treated), to ensure sufficient within-city control variation for credible counterfactuals.
The resulting balanced sample includes $7,279$ Census tracts across 45 CBSAs, and 687 projects with 294,022 total public housing units located in 628 treated tracts.
